...
export const Footer = ({
  ...
  return (
    <div
      className='px-10 pt-5 mt-10 md:px-32'
      style={{
        background: darken(0.03, bgColor)
      }}
    >
      <div className='flex flex-wrap items-start justify-between w-full gap-10 py-10'>
        ...
        <div className='flex self-end gap-10 text-center md:gap-20'>
      ...
      <div
        className='flex items-center justify-between py-8 text-gray-400 border-t text-md'
      ...
      {/* <div className="flex flex-row justify-center font-medium text-md">
